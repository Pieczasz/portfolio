...
const ZabrzeFranciszekPage = () => {
	...
	const screenshots = [
		assetPath("/zabrze-franciszek/zabrze_franciszek_page.jpg"),
		assetPath("/zabrze-franciszek/zabrze_franciszek_posts.jpg"),
		assetPath("/zabrze-franciszek/zabrze_franciszek_post_creation.jpg"),
		assetPath("/zabrze-franciszek/zabrze_franciszek_users.jpg"),
	];
		...
		<MaxWidthWrapper>
			...
			>
				<motion.div variants={variants} className="flex items-center gap-4">
					<Image
						src={assetPath("/zabrze_franciszek_logo.svg")}
