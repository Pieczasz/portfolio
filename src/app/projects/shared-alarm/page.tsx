...
const SharedAlarmPage = () => {
	...
	const screenshots = [
		assetPath("/shared-alarm/shared_alarm_creation.jpg"),
		assetPath("/shared-alarm/shared_alarm_clock.jpg"),
		assetPath("/shared-alarm/shared_alarm_stopwatch.jpg"),
		assetPath("/shared-alarm/shared_alarm_timer.jpg"),
	];
		...
		<MaxWidthWrapper>
			...
			>
				...
				<motion.div variants={variants} className="flex items-center gap-4">
					<Image
						src={assetPath("/shared_alarm_logo.png")}
