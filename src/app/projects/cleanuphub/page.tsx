...
const CleanupHubPage = () => {
	...
	const screenshots = [
		assetPath("/cleanuphub/cleanuphub_map.jpg"),
		assetPath("/cleanuphub/cleanuphub_event_creation.jpg"),
		assetPath("/cleanuphub/cleanuphub_event_page.jpg"),
		assetPath("/cleanuphub/cleanuphub_profile.jpg"),
	];
		...
		<MaxWidthWrapper>
			...
			>
				<motion.div variants={variants} className="flex items-center gap-4">
					<Image
						src={assetPath("/CleanupHubLogo.png")}
						alt="CleanupHub Logo"
						width={64}
						height={64}
